...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = SpecialRead("library", 'Users', '*', 'username', $tmp);
        ...
        <form method="post" enctype='multipart/form-data'
            ...
            <center style="margin-right:29.5%">
                ...
                <div class="d-flex" style="margin-top:0.5%">
                    ...
                    <div class="col-sm-5">
                        <input dir="ltr" type="text" class="form-control" name="password"   value="<?php if(isset($_POST['password'])){echo $_POST['password'];} ?>">
                    </div>
                </div>
            </center>
            ...
            <center style="margin-top:0.5%">
                ...
                <div class="col-sm-3 d-grid" style="margin-top:0.1%">
                    <a role="button" class="btn btn-outline-secondary" href="/library/SIGNIN.php">ثبت نام</a>
                </div>
                <div style="margin-top:0.1%">
                    <a role="button" class="btn btn-outline-dark" href="/library/AdminLogin.php">ورود مدیر</a>
                </div>
            </center>
